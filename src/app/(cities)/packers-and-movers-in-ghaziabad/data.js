                                ...
                                <div className="project-single-content">
                                    ...
                                    <div className="page-single-image">
                                        <figure className="image-anime reveal">
                                            <Image
                                                src="/assets/images/ghaziabad-img.jpg"
                                                alt="Ghaziabad City"
                                                width={800}   // set width
                                        ...
                                        <div className="faq-accordion" id="faqaccordion">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className="accordion-body">
                                                        <p>
                                                            We provide household shifting, office relocation, car & bike transport, local and domestic moving, and warehousing & storage solutions across Ghaziabad and nearby areas.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
